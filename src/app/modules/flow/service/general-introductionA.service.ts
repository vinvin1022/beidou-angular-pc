...
export class GeneralIntroductionAService {
  public eleColumn: object;
  public netColumn: object;
  ...
  generalIntroductionExportView(params = {}) {
    ...
    return this.requestHttp.exportExcel('dms/excelExport/spreadExcelExport', params);
