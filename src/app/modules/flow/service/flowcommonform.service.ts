...
export class FlowcommonformService {
  ...
  public defaultFormData = {
    ...
    carrier: [],   // 载体
    source: '全部',  // 推广来源
    queryDimension: 'fl_consulting_project', // 维度
  ...
  public queryDimensionOptions: Array<object> = [
    { key: 'men_area_name', value: '报名城市' },
    // { key: 'b', value: '业务模式' },
    { key: 'fl_consulting_project', value: '推广项目' },
    { key: 'dept_name_1', value: '流量军团' },
    { key: 'dept_name_2', value: '流量组' },
    { key: 'user_name', value: '流量人员' },
    { key: 'account_name', value: '推广账户' },
    { key: 'site_number', value: '推广站点' },
    { key: 'web_uid', value: '主域名' },
    { key: 'code', value: '推广渠道' },
    { key: 'city_name', value: '推广城市' },
    { key: 'advertisers_type', value: '推广方式' },
    { key: 'source', value: '推广来源' },
    { key: 'carrier', value: '载体' }
  ];
