...
@Component({
  selector: 'app-common-settarget',
  templateUrl: './common-settarget.component.html',
  styleUrls: ['./common-settarget.component.scss']
})
export class CommonSettargetComponent implements OnInit {
